...
5. add PostgreSQL/transactional-outbox persistence and OIDC/internal authorization through the accepted interfaces, then prove restart, concurrent-writer, and transaction-boundary behavior
