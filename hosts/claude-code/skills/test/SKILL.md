...
9. Paste **`expert_session_report.markdown`** (Senior Expert voice) as the primary user-facing write-up; also honor `expert_observations` + `expert_judgment.senior_verdict_line`.  
